...
public class Itemsets{
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#printItemsets(int)
	 */
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#addItemset(patterns.itemset_array_integers_with_count.Itemset, int)
	 */
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#getLevels()
	 */
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#getItemsetsCount()
	 */
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#setName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see patterns.itemset_array_integers_with_count.AbstractItemsets#decreaseItemsetCount()
	 */
